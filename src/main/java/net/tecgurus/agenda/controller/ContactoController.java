...
public class ContactoController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (accion.equals("traerContactos")) {
			...
			List<Contacto> contactos = contactoService.getContactByPage(Integer.valueOf(id), Integer.valueOf(offset),
			...
			Map<String, Object> contactos = contactoService.search(Integer.valueOf(id), search, Integer.valueOf(page),
					Integer.valueOf(limit));
			response.setContentType("application/json");
			response.setCharacterEncoding("utf-8");
			response.getWriter().write(new Gson().toJson(contactos));
